        ...
        <Routes>
            <Route element={<Wallet />}>
                <Route element={<ShowNavBar />}>
                    ...
                    />
                    <Route
                        path={routes.eventResale()}
                        element={
                            <RequireWallet redirect={SingleEventResaleView} />
                        }
                    />
                    <Route
                        path={routes.purchases()}
                        element={<RequireWallet redirect={PurchasesView} />}
                    />
                    <Route
                        path="*"
            ...
            <Route element={<Admin />}>
                ...
                <Route
                    ...
                    element={<RequireAdmin redirect={AdminEventsView} />}
                />
                <Route
                    path={routes.admin.event()}
                    element={
                        <RequireAdmin redirect={AdminCreateEditEventView} />
                    }
                />
                <Route
                    path={routes.admin.qr()}
                    element={<RequireAdmin redirect={AdminQrScanView} />}
                />
            </Route>
        </Routes>
    );
