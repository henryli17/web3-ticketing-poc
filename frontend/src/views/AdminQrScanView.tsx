...
const AdminQrScanView = () => {
    ...
    const markTicketAsUsed = async () => {
        ...
        try {
            ...
            setAlertMessage(
                "Tickets were validated and have now been marked as used.",
            );
        } catch (e: any) {
            setAlertTitle("Error");
            ...
            if (e?.response?.data?.message) {
                setAlertMessage(
                    "Tickets were invalid. Reason: " + e.response.data.message,
                );
            } else {
                setAlertMessage(
                    "There was an issue whilst trying to mark tickets as used.",
                );
            }
        }
