...
const AdminEventCard = (props: { event: Event; onCancel: () => any }) => {
    ...
    return (
        <>
            <EventCard
                event={props.event}
                to={routes.admin.event(props.event.id)}
            >
                <div className="col-span-12 lg:col-span-4 xl:col-span-3 pt-5 lg:pt-0 flex">
            ...
            {showErrorModal && (
                <AlertModal
                    ...
                    message={
                        errorMessage ||
                        "An error occurred when trying to cancel the event."
                    }
